...
# 2D and fingerprint descriptors for sets of compounds and
...
INPUT_COMP_SMFLUO1="../../data/intermediate/smfluo1_db/compounds/comp.smi"
INPUT_COMP_UVVISML="../../data/intermediate/uvvisml_db/compounds/comp.smi"
INPUT_COMP_CHEMDE="../../data/intermediate/chemde_db/compounds/comp.smi"
INPUT_SOLV_SMFLUO1="../../data/intermediate/smfluo1_db/solvents/solv.smi"
INPUT_SOLV_UVVISML="../../data/intermediate/uvvisml_db/solvents/solv.smi"
INPUT_SOLV_CHEMDE="../../data/intermediate/chemde_db/solvents/solv.smi"
OUTPUT_COMP_SMFLUO1="../../data/intermediate/smfluo1_db/compounds/comp_descriptors.csv"
OUTPUT_COMP_UVVISML="../../data/intermediate/uvvisml_db/compounds/comp_descriptors.csv"
OUTPUT_COMP_CHEMDE="../../data/intermediate/chemde_db/compounds/comp_descriptors.csv"
OUTPUT_SOLV_SMFLUO1="../../data/intermediate/smfluo1_db/solvents/solv_descriptors.csv"
OUTPUT_SOLV_UVVISML="../../data/intermediate/uvvisml_db/solvents/solv_descriptors.csv"
OUTPUT_SOLV_CHEMDE="../../data/intermediate/chemde_db/solvents/solv_descriptors.csv"

# === RUNNING PADEL FOR SMFLUO ===

mkdir -p "temp"
split -l 10 "$INPUT_COMP_SMFLUO1" "temp/smi_chunk_"
