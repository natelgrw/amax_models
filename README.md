...
AMAX-1 is an open source dataset and collection of machine learning models under active development designed to predict the λ<sub>max</sub> of chemical compounds and aid LC-MS compound characterization workflows.
